...
**Updated:** 2026-09-21 America/Chicago with Proof-21 MPE2 community unified affect-bias sweep VERIFY PASS  
**Next fork:** HOLD until further Matt/Riffbot greenlight
...
Named affects = clusters of movement impulses (fight / flight / freeze / capitulate / laugh / love). See **[AFFECT_ROUTE_MAP.md](AFFECT_ROUTE_MAP.md)** (Barrett lineage cite + locked glosses). **P16–P18** affect trilogy sealed. **P19** beat-frozen. **P20** custom unified sweep. **P21** Farama MPE2 community port of the unified sweep (mixed / partially confirmatory).

## Scoreboard

| GO | Instrument | Result | Headline |
|----|------------|--------|----------|
| PATHB-4 | SMAC-lite trash fog; residual_gate vs blind | **inverse** | cool→HOLD collapses success 1.0→0.0 |
| PATHB-5 | same arena; measured thrash (no engage HOLD) | thrash≈blind ceiling | both success 1.0; recovers P4 collapse; waste≈blind |
...
Public = redacted headlines + SHA anchors. Nest = full logs / harness trees / VERIFY bundles.
